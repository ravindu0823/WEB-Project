...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_SESSION['logged_in'])) {
        ...
        if (mysqli_connect_error()) {
            ...
            $sql = 'INSERT INTO `hockey` (`student_id`) VALUES ("' . $id . '")';
            ...
            if ($conn->query($sql) === true) {
                ...
                array_push($messages, 'You are successfully added to the NSBM Hockey Club');
    ...
    <div style="background-color: #F0F0F0">
        ...
        <div class="container pb-3">
            ...
            if (isset($_SESSION['user_data']['enrolments'])) {
                ...
                if (array_key_exists('hockey', $enrolments)) {
                    if ($enrolments['hockey'] == 1) { ?>
                    ...
                    <?php } else { ?>
                        <form action="hockey.php" method="post">
                            <div class="pt-5">
                                <button type="submit" class="btn btn-lg btn-primary w-100">Join NSBM Hockey Club
                                </button>
                            </div>
                        </form>
                    <?php }
