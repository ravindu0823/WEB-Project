    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="row" style="text-align: center">
                ...
                <div class="col-lg">
                    <a href="../sports/badminton.php" style="text-decoration: none">
                ...
                <div class="col-lg mt-auto">
                    <a href="../sports/cricket.php" style="text-decoration: none">
                ...
                <div class="col-lg mt-auto">
                    <a href="../sports/rugby.php" style="text-decoration: none">
                ...
                <div class="col-lg">
                    <a href="../sports/swimming.php" style="text-decoration: none">
            ...
            <div class="row mt-5" style="text-align: center">
                <div class="col-lg">
                    <a href="../sports/basketball.php" style="text-decoration: none">
                ...
                <div class="col-lg">
                    <a href="../sports/tt.php" style="text-decoration: none">
                ...
                <div class="col-lg mt-auto">
                    <a href="../sports/netball.php" style="text-decoration: none">
                ...
                <div class="col-lg mt-auto">
                    <a href="../sports/ma.php" style="text-decoration: none">
                ...
                <div class="col-lg">
                    <a href="../sports/hockey.php" style="text-decoration: none">
            ...
            <div class="row mt-5" style="text-align: center">
                <div class="col-lg">
                    <a href="../sports/chess.php" style="text-decoration: none">
                ...
                <div class="col-lg">
                    <a href="../sports/volleyball.php" style="text-decoration: none">
                ...
                <div class="col-lg mt-auto">
                    <a href="../sports/archery.php" style="text-decoration: none">
                ...
                <div class="col-lg mt-auto">
                    <a href="../sports/fitness.php" style="text-decoration: none">
                ...
                <div class="col-lg">
                    <a href="../sports/soccer.php" style="text-decoration: none">
