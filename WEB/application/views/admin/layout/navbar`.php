...
">
    ...
    <span style="padding-top: 2px; text-shadow: 2px 2px black; font-family: 'rozha one'"><span style="color: #007BFF">NSBM</span> <span
                style="color: #02CD22;">SPORTS <span style="color: red">ADMIN PANEL</span></span></span>
</div>

<nav class="navbar sticky-top navbar-expand-lg navbar-dark bg-primary">
    <div class="container">
            <a href="logout.php" class="d-flex nav-item mx-2 w-100 " style="text-decoration: none;">
                <button class="btn btn-danger py-3 w-100">Logout</button>
            </a>
        </div>
    </div>
</nav>